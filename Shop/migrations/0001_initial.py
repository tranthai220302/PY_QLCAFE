    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ordering', 'ordering'), ('delivery', 'delivery'), ('received', 'received')], default='ordering', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Dish',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Coffee', 'Coffee'), ('Milk_Tea', 'Milk_Tea'), ('Cake', 'Cake')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('number_phone', models.TextField(max_length=10)),
                ('image', models.FileField(blank=True, default='img/avata.jpg', null=True, upload_to='images/')),
